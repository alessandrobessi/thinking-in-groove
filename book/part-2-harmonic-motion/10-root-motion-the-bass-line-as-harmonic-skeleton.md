...
[V:LH] "^step"_E,2 F,2 G,2 _A,2 | "^step"G,2 F,2 _E,2 F,2 | "^step"G,2 _A,2 _B,2 C,2 | "^step"_B,2 _A,2 G,2 _A,2 |
"^step"_B,2 C,2 D,2 _E2 | "^step"D,2 C,2 _B,2 _A,2 | "^step"_B,2 C,2 D,2 _E2 | "^step: settle"F2 _E2 D,2 _B,2 |]</pre>
  <div class="abc-rendered"></div>
</div>
```
