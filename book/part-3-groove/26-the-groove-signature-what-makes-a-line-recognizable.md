...
“Early Light” is an original eight-bar jazz study in Gb major, swung throughout. Each bar develops a compact chord-tone idea, then the next root enters on the final eighth and ties across the boundary. The second four bars vary the internal line while preserving that anticipatory phrase rhythm.
...
<div class="score-example" id="early-light-study">
  ...
  <p class="abc-description">A swung eight-bar functional-jazz miniature with sustained piano harmony and tied root anticipations.</p>
  <pre class="abc-source">X:1
T:Early Light
C:Alessandro Bessi
R:Jazz study
...
[V:LH] "^anticipatory phrase"_G,2 _D>_B, z1 _E,1- | _E,1 _B,>_G, z2 _A,1- | _A,1 _E>B, z2 _D,1- | _D,1 _A,>B, z2 _G,1- | _G,1 _B,>F, z2 _E,1- | _E,1 _G,>_D z2 _A,1- | _A,1 B,>_G, z2 _D,1- | _D,1 F,>_A, z2 "^points beyond the excerpt"_G,1 |]</pre>
  <div class="abc-rendered"></div>
</div>
```
