...
"Slow Descent" is an eight-bar ballad that traces a continuous C-B-A-G-F line purely through inversions of Cmaj7, Am7, and Dm7 — no note outside any chord's own tones — before a plain root-position Dm7-G7-Cmaj7 cadence resolves the line home.
...
<div class="score-example" id="slow-descent-study">
  ...
  <p class="abc-description">An eight-bar ballad using inversions of Cmaj7, Am7, and Dm7 to trace a falling bass line before a closing cadence.</p>
  <pre class="abc-source">X:1
T:Slow Descent
C:Alessandro Bessi
R:Ballad
...
"Dm7"[dfa]8 | [dfa]8 | "G7"[gbd]8 | "Cmaj7"[ceg]8 |]
[V:LH] "^root"C,,8 | "^inversion"B,,8 | "^root"A,,8 | "^inversion"G,,8 |
"^inversion"F,,8 | "^root"D,,8 | "^root"G,,8 | "^resolve"C,,8 |]</pre>
  <div class="abc-rendered"></div>
</div>
```
